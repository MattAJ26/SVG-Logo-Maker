...
describe('Triangle', () => {
    describe('render() method', () => {
        ...
        <text x="150" y="145" font-size="50" text-anchor="middle" fill="${textColor}">${text}</text>
        </svg>`);
        })
    })
})
...
describe('Square', () => {
    describe('render() method', () => {
        ...
        <text x="100" y="110" font-size="50" text-anchor="middle" fill="${textColor}">${text}</text>
        </svg>`);
        })
    })
})
...
describe('Circle', () => {
    describe('render() method', () => {
        ...
        <text x="50" y="66" font-size="50" text-anchor="middle" fill="${textColor}">${text}</text>
      </svg>`);
        })
    })
})