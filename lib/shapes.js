...
class Circle extends Shape {
    ...
    render() {
        ...
        <text x="50" y="66" font-size="50" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
      </svg>`
    }
};
...
class Triangle extends Shape {
    ...
    render() {
        ...
        <text x="150" y="145" font-size="50" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
        </svg>`
    }
};
